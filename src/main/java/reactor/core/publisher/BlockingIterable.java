...
final class BlockingIterable<T> implements Iterable<T>, Scannable {
	...
	public Object scanUnsafe(Attr key) {
		if (key == IntAttr.PREFETCH) return (int) batchSize; //FIXME should batchSize be forced to int?
	...
	static final class SubscriberIterator<T>
		...
		public Object scanUnsafe(Attr key) {
			...
			if (key == IntAttr.PREFETCH) return (int) batchSize; //FIXME should batchSize be typed int?
